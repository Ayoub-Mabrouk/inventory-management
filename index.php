...
<body>
                ...
                <div id="search-box">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21.512" height="21.516" viewBox="0 0 21.512 21.516">
                        <path id="Icon_awesome-search" data-name="Icon awesome-search"
                            d="M21.22,18.6,17.03,14.412a1.008,1.008,0,0,0-.714-.294h-.685a8.736,8.736,0,1,0-1.513,1.513v.685a1.008,1.008,0,0,0,.294.714L18.6,21.22a1,1,0,0,0,1.424,0l1.189-1.189a1.013,1.013,0,0,0,0-1.429ZM8.74,14.118A5.378,5.378,0,1,1,14.118,8.74,5.375,5.375,0,0,1,8.74,14.118Z"
                            fill="#9b9b9b" />
                    </svg>
                        ...
                        <div class="edit-delete">
                            ...
                            <svg class="edit_button" xmlns="http://www.w3.org/2000/svg" width="30.302" height="26.93"
                                ...
                                <path id="Icon_awesome-edit" data-name="Icon awesome-edit"
                                    ...
                                    transform="translate(0 -0.007)" fill="#9b9b9b" />
                            </svg>


                            <svg class="delete" xmlns="http://www.w3.org/2000/svg" width="20.945" height="26.93"
                                viewBox="0 0 20.945 26.93">
                                <path id="Icon_material-delete-forever" data-name="Icon material-delete-forever"
                                    d="M9,28.438a3,3,0,0,0,2.992,2.992H23.957a3,3,0,0,0,2.992-2.992V10.484H9Zm3.68-10.652,2.11-2.11,3.187,3.172,3.172-3.172,2.11,2.11-3.172,3.172,3.172,3.172-2.11,2.11-3.172-3.172L14.8,26.238l-2.11-2.11,3.172-3.172ZM23.209,6l-1.5-1.5H14.232L12.736,6H7.5V8.988H28.445V6Z"
                                    transform="translate(-7.5 -4.5)" fill="#9b9b9b" />
                            </svg>
    ...
    <div id="addproduct_popup" class="popup container add">
        ...
        <div class="two-buttons">
            <button id="close-add" onclick="close_add_pop()">CLOSE</button>
            <button id="add-button2">ADD PRODUCT</button>
        </div>
    </div>
    <div id="editproduct_popup" class="popup container edit">
        ...
        <div class="two-buttons">
            <button id="close-edit" onclick="close_edit_pop()">CLOSE</button>
        ...
        <div class="close-info-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="29.25" height="29.25" viewBox="0 0 29.25 29.25">
                <path id="Icon_ionic-ios-close-circle" data-name="Icon ionic-ios-close-circle"
                    ...
                    transform="translate(-3.375 -3.375)" fill="#9b9b9b" />
            </svg>
        ...
        <div class="add-prod">
            <svg xmlns="http://www.w3.org/2000/svg" width="26.76" height="26.76" viewBox="0 0 26.76 26.76">
                <path id="Icon_material-add-circle-outline" data-name="Icon material-add-circle-outline"
                    d="M17.718,9.69H15.042v5.352H9.69v2.676h5.352V23.07h2.676V17.718H23.07V15.042H17.718ZM16.38,3A13.38,13.38,0,1,0,29.76,16.38,13.385,13.385,0,0,0,16.38,3Zm0,24.084a10.7,10.7,0,1,1,10.7-10.7A10.718,10.718,0,0,1,16.38,27.084Z"
        ...
        <div class="profile-mobile">
            <svg xmlns="http://www.w3.org/2000/svg" width="26.76" height="26.76" viewBox="0 0 26.76 26.76">
                <path id="Icon_awesome-user-alt" data-name="Icon awesome-user-alt"
                    d="M13.38,15.053A7.526,7.526,0,1,0,5.854,7.526,7.528,7.528,0,0,0,13.38,15.053Zm6.69,1.673H17.19a9.1,9.1,0,0,1-7.62,0H6.69A6.69,6.69,0,0,0,0,23.415v.836A2.509,2.509,0,0,0,2.509,26.76H24.252a2.509,2.509,0,0,0,2.509-2.509v-.836A6.69,6.69,0,0,0,20.07,16.725Z"
                    fill="#9b9b9b" />
            </svg>
        </div>
    </div>
